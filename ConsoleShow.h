...
public:
	...
	virtual void showPossibleMoves(const vector<point> *,const bool turn);//printing the given possible moves. turn present the current player
	...
	virtual void showMove(const point *,const bool turn);//printing the last move happen
	virtual ~ConsoleShow();
};
